...
public class Variable {
	...
	public static void printVariable() {
		 ...
		 * - 재사용성 증가 (한번 값을 저장하여 필요할 때마다 변수이름으로 가져다 사용)
	...
	public static void declareVariable() {
		 ...
		 * 			=> 클래스명의 경우 : 대문자로 시작(소문자도 오류는 안나지만 그러기로함)
		 * 		[2] 대소문자를 구분함
		 * 		[3] 숫자로 시작하면 안됨, 예약어 사용 불가 (이미 의미가 부여된 친구들)
		 * 		[4] 특수문자는 '$' 또는 '_'만 사용가능
		 * 
		 * 주의사항
		 *		- 같은 영역 안({}) 에서는 동일한 변수명 사용  
		...
		System.out.println("isFalse의 값은 : " + isFalse);
...
//		bNum = 1000; // 범위를 벋어나면 오류 발생! (byte형) = (int형)
...
//				float(4B) / double (8B)
		...
		//	[표현법] final 자료형 상수명;
		final int AGE; 		// 명명규칙 : 대문자만 사용, 단어사이는 '_'로 구분
		AGE = 10;
